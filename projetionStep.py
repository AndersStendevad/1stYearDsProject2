...
def projection(G,nodes,projection_type):
    ...
    if projection_type == "simple":
        ...
        pr.cprint("There is no projection type: " + projection_type, color = '\033[91m')
